export const dict = {
  ...
  "divein.title": "DiveIn",
  "divein.trackCount.one": "{{count}} track",
  "divein.trackCount.other": "{{count}} tracks",
  "divein.status.working": "Working",
  "divein.status.retrying": "Retrying",
  "divein.status.queued": "Queued",
  "divein.status.ready": "Ready",
  "divein.status.done": "Done",
  "divein.status.closed": "Closed",
  "divein.open": "Open DiveIn tracks",
  "divein.markComplete": "Mark track complete",
  "divein.reopen": "Reopen track",
  "divein.cancel.title": "Cancel DiveIn",
  "divein.cancel.confirm.one": "Cancel DiveIn and remove its current track? The main session will be preserved.",
  "divein.cancel.confirm.other":
    "Cancel DiveIn and remove its {{count}} current tracks? The main session will be preserved.",
  "divein.cancel.button": "Cancel DiveIn",
  "divein.initialPrompt": "Initial prompt",
