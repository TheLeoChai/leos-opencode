...
type Endpoint4_0Request = Parameters<RawClient["server.diveIn"]["diveIn.list"]>[0]
type Endpoint4_0Input = { readonly location?: Endpoint4_0Request["query"]["location"] }
const Endpoint4_0 = (raw: RawClient["server.diveIn"]) => (input?: Endpoint4_0Input) =>
  raw["diveIn.list"]({ query: { location: input?.["location"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint4_1Request = Parameters<RawClient["server.diveIn"]["diveIn.get"]>[0]
type Endpoint4_1Input = { readonly diveInID: Endpoint4_1Request["params"]["diveInID"] }
const Endpoint4_1 = (raw: RawClient["server.diveIn"]) => (input: Endpoint4_1Input) =>
  raw["diveIn.get"]({ params: { diveInID: input["diveInID"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint4_2Request = Parameters<RawClient["server.diveIn"]["diveIn.start"]>[0]
type Endpoint4_2Input = {
  readonly sessionID: Endpoint4_2Request["params"]["sessionID"]
  readonly guidance?: Endpoint4_2Request["payload"]["guidance"]
}
const Endpoint4_2 = (raw: RawClient["server.diveIn"]) => (input: Endpoint4_2Input) =>
  raw["diveIn.start"]({ params: { sessionID: input["sessionID"] }, payload: { guidance: input["guidance"] } }).pipe(
    Effect.mapError(mapClientError),
  )

type Endpoint4_3Request = Parameters<RawClient["server.diveIn"]["diveIn.cancel"]>[0]
type Endpoint4_3Input = {
  readonly sessionID: Endpoint4_3Request["params"]["sessionID"]
  readonly diveInID: Endpoint4_3Request["params"]["diveInID"]
}
const Endpoint4_3 = (raw: RawClient["server.diveIn"]) => (input: Endpoint4_3Input) =>
  raw["diveIn.cancel"]({ params: { sessionID: input["sessionID"], diveInID: input["diveInID"] } }).pipe(
    Effect.mapError(mapClientError),
  )

type Endpoint4_4Request = Parameters<RawClient["server.diveIn"]["diveIn.complete"]>[0]
type Endpoint4_4Input = {
  readonly sessionID: Endpoint4_4Request["params"]["sessionID"]
  readonly diveInID: Endpoint4_4Request["params"]["diveInID"]
  readonly trackID: Endpoint4_4Request["params"]["trackID"]
  readonly satisfied: Endpoint4_4Request["payload"]["satisfied"]
}
const Endpoint4_4 = (raw: RawClient["server.diveIn"]) => (input: Endpoint4_4Input) =>
  raw["diveIn.complete"]({
    params: { sessionID: input["sessionID"], diveInID: input["diveInID"], trackID: input["trackID"] },
    payload: { satisfied: input["satisfied"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint4_5Request = Parameters<RawClient["server.diveIn"]["diveIn.reopen"]>[0]
type Endpoint4_5Input = {
  readonly sessionID: Endpoint4_5Request["params"]["sessionID"]
  readonly diveInID: Endpoint4_5Request["params"]["diveInID"]
  readonly trackID: Endpoint4_5Request["params"]["trackID"]
}
const Endpoint4_5 = (raw: RawClient["server.diveIn"]) => (input: Endpoint4_5Input) =>
  raw["diveIn.reopen"]({
    params: { sessionID: input["sessionID"], diveInID: input["diveInID"], trackID: input["trackID"] },
  }).pipe(Effect.mapError(mapClientError))

const adaptGroup4 = (raw: RawClient["server.diveIn"]) => ({
  list: Endpoint4_0(raw),
  get: Endpoint4_1(raw),
  start: Endpoint4_2(raw),
  cancel: Endpoint4_3(raw),
  complete: Endpoint4_4(raw),
  reopen: Endpoint4_5(raw),
})
...
const adaptClient = (raw: RawClient) => ({
  ...
  diveIn: adaptGroup4(raw["server.diveIn"]),
