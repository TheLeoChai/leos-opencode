...
- `threshold` - Fraction of usable context that triggers automatic compaction (default: `0.7`). Must be greater than `0` and no greater than `1`.
- `target` - Fraction of usable context to retain as recent history during proactive compaction (default: `0.45`). Must be greater than `0` and no greater than `1`.
